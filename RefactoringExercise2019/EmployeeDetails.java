...
public class EmployeeDetails extends JFrame implements ActionListener, ItemListener, DocumentListener, WindowListener {
	...
	private JPanel searchPanel() {
		...
		searchPanel.add(new JLabel("Search by ID:"), Layout.Layout1);
		...
		searchPanel.add(new JLabel("Search by Surname:"), Layout.Layout1);
	...
	private JPanel buttonPanel() {
		...
		buttonPanel.add(add = new JButton("Add Record"), Layout.Layout1);
		add.addActionListener(this);
		add.setToolTipText("Add new Employee Record");
		buttonPanel.add(edit = new JButton("Edit Record"), Layout.Layout1);
		edit.addActionListener(this);
		edit.setToolTipText("Edit current Employee");
		buttonPanel.add(deleteButton = new JButton("Delete Record"), Layout.Layout2);
		deleteButton.addActionListener(this);
		deleteButton.setToolTipText("Delete current Employee");
		buttonPanel.add(displayAll = new JButton("List all Records"), Layout.Layout1);
	...
	private JPanel detailsPanel() {
		...
		empDetails.add(genderCombo = new JComboBox<String>(gender), Layout.Layout2);

		empDetails.add(new JLabel("Department:"), Layout.Layout1);
		empDetails.add(departmentCombo = new JComboBox<String>(department), Layout.Layout2);
		...
		empDetails.add(fullTimeCombo = new JComboBox<String>(fullTime), Layout.Layout2);
